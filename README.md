...
- Clone this repository by writing `git clone https://github.com/businesskaniki/hello-rails-react.git`
...
- GitHub: [nick](https://github.com/bussinesskaniki)
- LinkedIn: [nick](https://twitter.com/businesskaaniki)
